...
#![allow(clippy::all)]
// manually generated by rust-bindgen 
// so that the clans-sys and cc dependency is not
// required so that we can compile for other architectures

pub const ONIGURUMA_VERSION_MAJOR: u32 = 6;
pub const ONIGURUMA_VERSION_MINOR: u32 = 9;
pub const ONIGURUMA_VERSION_TEENY: u32 = 2;
pub const ONIGURUMA_VERSION_INT: u32 = 60902;
...
fn bindgen_test_layout_OnigEncodingTypeST() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OnigEncodingTypeST>())).mbc_enc_len as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(OnigEncodingTypeST),
            "::",
            stringify!(mbc_enc_len)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OnigEncodingTypeST>())).init as *const _ as usize },
        120usize,
        concat!(
            "Offset of field: ",
            stringify!(OnigEncodingTypeST),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<OnigEncodingTypeST>())).is_initialized as *const _ as usize
        },
        128usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<OnigEncodingTypeST>())).is_valid_mbc_string as *const _ as usize
        },
        136usize,
        concat!(
            "Offset of field: ",
            stringify!(OnigEncodingTypeST),
            "::",
            stringify!(is_valid_mbc_string)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OnigEncodingTypeST>())).flag as *const _ as usize },
        144usize,
        concat!(
            "Offset of field: ",
            stringify!(OnigEncodingTypeST),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OnigEncodingTypeST>())).sb_range as *const _ as usize },
        148usize,
        concat!(
            "Offset of field: ",
            stringify!(OnigEncodingTypeST),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OnigEncodingTypeST>())).index as *const _ as usize },
        152usize,
        concat!(
            "Offset of field: ",
            stringify!(OnigEncodingTypeST),
...
#[test]
fn bindgen_test_layout_OnigValue__bindgen_ty_1() {
    assert_eq!(
        ::std::mem::size_of::<OnigValue__bindgen_ty_1>(),
        16usize,
        concat!("Size of: ", stringify!(OnigValue__bindgen_ty_1))
    );
    assert_eq!(
        ::std::mem::align_of::<OnigValue__bindgen_ty_1>(),
        8usize,
        concat!("Alignment of ", stringify!(OnigValue__bindgen_ty_1))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OnigValue__bindgen_ty_1>())).start as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(OnigValue__bindgen_ty_1),
            "::",
            stringify!(start)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OnigValue__bindgen_ty_1>())).end as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(OnigValue__bindgen_ty_1),
...
#[test]
fn bindgen_test_layout_OnigValue() {
    assert_eq!(
        ::std::mem::size_of::<OnigValue>(),
        16usize,
        concat!("Size of: ", stringify!(OnigValue))
    );
    assert_eq!(
        ::std::mem::align_of::<OnigValue>(),
        8usize,
        concat!("Alignment of ", stringify!(OnigValue))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OnigValue>())).l as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(OnigValue),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OnigValue>())).c as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(OnigValue),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OnigValue>())).s as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(OnigValue),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OnigValue>())).p as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(OnigValue),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<OnigValue>())).tag as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(OnigValue),
